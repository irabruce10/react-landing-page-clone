      ...
      <div className={styles.wrapper}>
        ...
        <div className={styles.items}>
          <div>
            ...
            <h3>Take your style quiz</h3>
            <p>
              Tell us about your style, sizes and budget—the more we know, the
              more your men’s Stylist can help.
            </p>
          ...
          <div>
            ...
            />
            <div>1.</div>
            <h3>2. Match with your (human!) Stylist</h3>
            <p>
              Let your Stylist know what you’re looking for. They’ll select 5
              personalized pieces, and send your men's clothing box straight to
              your door.
            </p>{' '}
            <img
          ...
          <div>
            ...
            />
            <div>1.</div>
            <h3>3. Get your personalized Fix</h3>
            <p>
              There’s a $20 styling fee per box (aka "Fix") order, which is then
              credited to whatever you choose to keep. Shipping and returns are
              always free.
            </p>
